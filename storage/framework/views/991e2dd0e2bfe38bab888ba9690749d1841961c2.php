                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="<?php echo e(route('subjects.store')); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="name" name="name" value="<?php echo e(old('name')); ?>" required type="text" class="form-control" placeholder="Name of course">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\btec\Application-Development\app\lav_sms\resources\views/pages/support_team/subjects/index.blade.php ENDPATH**/ ?>