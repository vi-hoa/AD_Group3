        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu <?php echo e(in_array(Route::currentRouteName(), ['students.create', 'students.list', 'students.edit', 'students.show', 'students.promotion', 'students.promotion_manage', 'students.graduated']) ? 'nav-item-expanded nav-item-open' : ''); ?> ">
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Manage Students">
                            ...
                            <?php if(Qs::userIsTeamSA()): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('students.create')); ?>"
                                       class="nav-link <?php echo e((Route::is('students.create')) ? 'active' : ''); ?>">Admit Trainee</a>
                                </li>
                            <?php endif; ?>
                            ...
                            <li class="nav-item nav-item-submenu <?php echo e(in_array(Route::currentRouteName(), ['students.list', 'students.edit', 'students.show']) ? 'nav-item-expanded' : ''); ?>">
                                <a href="#" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['students.list', 'students.edit', 'students.show']) ? 'active' : ''); ?>">Trainee Information</a>
                                <ul class="nav nav-group-sub">
                            ...
                            <li class="nav-item nav-item-submenu <?php echo e(in_array(Route::currentRouteName(), ['students.promotion', 'students.promotion_manage']) ? 'nav-item-expanded' : ''); ?>"><a href="#" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['students.promotion', 'students.promotion_manage' ]) ? 'active' : ''); ?>">Trainee Promotion</a>
                            <ul class="nav nav-group-sub">
                                <li class="nav-item"><a href="<?php echo e(route('students.promotion')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['students.promotion']) ? 'active' : ''); ?>">Promote Trainee</a></li>
                            ...
                            <li class="nav-item"><a href="<?php echo e(route('students.graduated')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['students.graduated' ]) ? 'active' : ''); ?>">Trainee Completed</a></li>
                                <?php endif; ?>
                ...
                <?php if(Qs::userIsTeamSA()): ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('sections.index')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['sections.index','sections.edit',]) ? 'active' : ''); ?>"><i class="icon-fence"></i> <span>Trainer</span></a>
                    </li>

                    
                    <li class="nav-item">
                        <a href="<?php echo e(route('subjects.index')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['subjects.index','subjects.edit',]) ? 'active' : ''); ?>"><i class="icon-pin"></i> <span>Courses</span></a>
                    </li>
                <?php endif; ?>
...
<?php /**PATH E:\btec\Application-Development\app\lav_sms\resources\views/partials/menu.blade.php ENDPATH**/ ?>