...
<?php $__env->startSection('page_title', 'Trainee Informations - '.$my_class->name); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-students" class="nav-link active" data-toggle="tab">All <?php echo e($my_class->name); ?> Trainees</a></li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\btec\Application-Development\app\lav_sms\resources\views/pages/support_team/students/list.blade.php ENDPATH**/ ?>